...
class CNN():
    def __init__(self, num_classes = 10, lr = 0.01, beta1 = 0.95, beta2 = 0.99, img_dim = 28, img_depth = 1, f = 5, num_filt1 = 8, num_filt2 = 8, batch_size = 32, num_epochs = 1, save_path = 'params.pkl'):
    ...
    def fit(self, X, y_dash):
        ...
        # print(X)
        # print(y_dash)
        train_data = np.hstack([X,y_dash.reshape(y_dash.shape[0],1)])


        np.random.shuffle(train_data)

        ## Initializing all the parameters
        f1, f2, w3, w4 = (self.num_filt1 ,self.img_depth,self.f,self.f), (self.num_filt2 ,self.num_filt1,self.f,self.f), (128,800), (10, 128)
